        ...
        pub fn prt(self: *Self) void {
            switch (T) {
                ...
                Complex(f32), Complex(f64) => {
                    ...
                    while (i_col < self.n_col) : (i_col += 1) {
                        print(" ({e:>10.3}, {e:>10.3})", .{
                            self.val[self.n_row * i_col].re,
                            self.val[self.n_row * i_col].im,
                        });
                    }
                    print("\n", .{});
                    ...
                    while (i_row < self.n_row - 1) : (i_row += 1) {
                        ...
                        print(" ", .{});
                        while (i_col < self.n_col) : (i_col += 1) {
                            print(" ({e:>10.3}, {e:>10.3})", .{ self.val[i_row + i_col * self.n_row].re, self.val[i_row + i_col * self.n_row].im });
                        }
                        print("\n", .{});
                    }
                    ...
                    print(" ", .{});
                    while (i_col < self.n_col) : (i_col += 1) {
                        print(" ({e:>10.3}, {e:>10.3})", .{ self.val[self.n_row - 1 + self.n_row * i_col].re, self.val[self.n_row - 1 + self.n_row * i_col].im });
                    }
                    print(" ]\n", .{});
                },
                else => @compileError("requested Matrix type is not allowed"),
